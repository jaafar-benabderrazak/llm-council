...
### 📝 Automatic Markdown Export (NEW!)

Every debate automatically generates a **beautiful Markdown file** with:

- ✅ **Mermaid Diagrams**: Visual debate flow and statistics
- ✅ **Round-by-Round Analysis**: Full agent responses organized by round
- ✅ **Comprehensive Synthesis**: The complete article with sources
- ✅ **Token Statistics**: Pie chart of token distribution
- ✅ **Metadata Table**: Key metrics and statistics
- ✅ **Professional Formatting**: Ready for GitHub, documentation, or publication

**Files Generated:**
- `debate_TIMESTAMP.json` - Raw structured data
- `article_TIMESTAMP.md` - Formatted article with Mermaid diagrams

**Use Cases for Markdown Export:**
- Share on GitHub (Mermaid renders automatically)
- Convert to PDF with pandoc
- Publish as blog posts or documentation
...
result = council.debate(
    ...
    save_markdown=True  # Saves Markdown article with Mermaid diagrams (default: True)
)
...
# - debate_20241226_143022.json (raw data)
# - article_20241226_143022.md (formatted article with diagrams)

# Manually save with custom filename
result.save_to_markdown("microservices_analysis")
# Creates: microservices_analysis.md
```

### Markdown Article Structure

The generated `.md` file includes:

```markdown
# [Your Topic]

**Generated by LLM Council** - [timestamp]
...
```mermaid
graph LR
    A[Topic] --> B[Multi-Round Debate]
    B --> C1[Claude]
    B --> C2[ChatGPT]
    B --> C3[Groq]
    C1 & C2 & C3 --> D[Synthesis]
    D --> E[Comprehensive Article]
```
...
#### Claude
*Tokens: 1,234, Model: claude-3-5-sonnet*

[Full agent response with sources]
...
[Your complete 11-section article with verified sources]
...
*Generated by LLM Council - Multi-Agent AI Research Framework*
```
